...
In a <a href="https://www.snorkel.org/blog/weak-supervision">data programming</a> approach, instead of providing binary labels, Joe writes functions (called "labeling functions" or LFs) that label data "accurately enough". These functions don't necessarily have perfect recall or precision, and they are allowed to overlap and conflict with one another.
