  ...
  class DataPage < Page
    ...
    def initialize(site, base, index_files, dir, data, name, template, extension)
      ...
      if data[name] == nil
        ...
        self.process(@name)
        self.read_yaml(base, template + ".html")
    ...
    def generate(site)
      ...
      if data
        data.each do |data_spec|
          ...
          layouts_source = site.config['layouts_dir'] || site.source
          ...
          if site.layouts.key? template
            ...
            records.each do |record|
              site.pages << DataPage.new(site, layouts_source, index_files_for_this_data, dir, record, name, template, extension)
            end
          else
