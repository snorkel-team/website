...
```
    ...
    Epoch 0::  96%|█████████▌| 24/25 [01:08<00:03,  3.01s/it, model/all/train/loss=0.376, model/all/train/lr=0.0001]/Users/braden/repos/snorkel-tutorials/.tox/spam/lib/python3.7/site-packages/sklearn/metrics/classification.py:1437: UndefinedMetricWarning: F-score is ill-defined and being set to 0.0 due to no predicted samples.
